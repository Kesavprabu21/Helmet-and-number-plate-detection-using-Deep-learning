...
DEMO_VIDEO = 'D:/projects/Helmet-detection-and-number-plate-Extraction-main/video.mp4'
...
if app_mode =='About App':
    ...
    data = pd.read_csv('D:/projects/Helmet-detection-and-number-plate-Extraction-main/coordss.csv')
